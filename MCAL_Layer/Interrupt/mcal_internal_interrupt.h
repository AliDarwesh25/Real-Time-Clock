 ...
 * Author: Ali
 *
 * Created on June 21, 2024, 8:39 PM
 */
...
/* This routine sets the interrupt enable for the MSSP SPI Module */
#define MSSP_SPI_InterruptEnable()        (PIE1bits.SSPIE = 1)
/* This routine clears the interrupt enable for the MSSP SPI Module */
#define MSSP_SPI_InterruptDisable()       (PIE1bits.SSPIE = 0)
/* This routine clears the interrupt flag for the MSSP SPI Module */
#define MSSP_SPI_InterruptFlagClear()     (PIR1bits.SSPIF = 0)
#if INTERRUPT_PRIORITY_LEVELS_ENABLE==INTERRUPT_FEATURE_ENABLE
/* This routine set the MSSP SPI Module Interrupt Priority to be High priority */
#define MSSP_SPI_HighPrioritySet()        (IPR1bits.SSPIP = 1)
/* This routine set the MSSP SPI Module Interrupt Priority to be Low priority */
