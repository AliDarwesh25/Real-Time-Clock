 ...
 * Created on April 24, 2024, 2:09 PM
 */
...
/**
 * @berif initialize lcd using 4 pins 
 * @param lcd
...
/**
 * @berif send commands to lcd to control it using 4 pins
 * @param lcd
 * @param command
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send data to lcd using 4 pins
...
/**
 * @berif send position of data to lcd using 4 pins
 * @param lcd
 * @param row
 * @param column
 * @param data
...
/**
 * @berif send string to lcd using 4 pins
 * @param lcd
 * @param str
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send position of  string to lcd using 4 pins
 * @param lcd
 * @param row
 * @param column
 * @param str
...
/**
 * @berif send custom character to lcd using 4 pins
 * @param lcd
 * @param row
 * @param column
 * @param _chr
...
/**
 * @berif initialize lcd using 8 pins
 * @param lcd
 * @return Status of the function
 *          (E_OK) : The function done successfully
 *          (E_NOT_OK) : The function has issue to perform this action
...
/**
 * @berif send commands to lcd to control it using 8 pins
 * @param lcd
 * @param command
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send data to lcd using 8 pins
 * @param lcd
 * @param data
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send position of data to lcd using 8 pins
 * @param lcd
 * @param row
 * @param column
 * @param data
...
/**
 * @berif send string to lcd using 8 pins
 * @param lcd
 * @param str
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send position of  string to lcd using 8 pins
 * @param lcd
 * @param row
 * @param column
 * @param str
...
/**
 * @berif convert the uint8 into string
 * @param value
 * @param str
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif convert the uint16 into string
 * @param value
 * @param str
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif convert the uint32 into string
 * @param value
 * @param str
 * @return Status of the function
 *          (E_OK) : The function done successfully
...
/**
 * @berif send enable signal to 4 bit lcd 
 * @param lcd
 * @return Status of the function
 *          (E_OK) : The function done successfully
 *          (E_NOT_OK) : The function has issue to perform this action
...
/**
 * @berif send enable signal to 8 bit lcd
 * @param lcd
 * @return Status of the function
 *          (E_OK) : The function done successfully
 *          (E_NOT_OK) : The function has issue to perform this action
...
/**
 * @berif set the cursor in 8 bit lcd
...
/**
 * @berif set the cursor in 4 bit lcd
 * @param lcd
 * @param row
 * @param coulmn
 * @return Status of the function
