...
/*This routine set the edge detect of the extern interrupt to the negative edge*/
#define EXT_INT0_RisingEdgeSet()       (INTCON2bits.INTEDG0 = 1)
/*This routine set the edge detect of the extern interrupt to the positive edge*/
